...
public class AdminFacade implements ClientFacade {
	...
	public static AdminFacade loginAdmin(String user, String password) throws CouponSystemException {
	...
	public JSONObject getCompany(int compID) throws CouponSystemException {
	...
	public JSONObject  getAllCompanies() throws CouponSystemException {
		...
		JSONArray companyJsonObjects = new JSONArray();
		for (int i = 0; i < compList.size(); i++) {
			companyJsonObjects.add(companyToJson(compList.get(i)));
	    }
		object.put("ArrayOfCompaniesObjects",companyJsonObjects);
